...
>(({ className, children, position = 'item-aligned', ...props }, ref) => (
    <SelectPrimitive.Portal>
        <SelectPrimitive.Content
            ...
            {...props}
        >
            <SelectPrimitive.ScrollUpButton className={cn('flex justify-center items-center h-6')}>
                <ChevronUpIcon />
            ...
            <SelectPrimitive.ScrollDownButton className={cn('flex justify-center items-center h-6')}>
                <ChevronDownIcon />
